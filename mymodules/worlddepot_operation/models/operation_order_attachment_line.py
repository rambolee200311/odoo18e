...
class OperationOrderHandoverAttachmentLine(models.Model):
    _name = "operation.order.attachment.line"
    ...
    doc_type = fields.Selection([("bl", "BL"), ("poa", "POA"),
                                 ("do", "DO/Telex Release"), ("apply_mail", "Apply Email"),
                                 ("release_mail", "Release Email"), ("other", "Other")], string="Document Type", required=True, index=True)
