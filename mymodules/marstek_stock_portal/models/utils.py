...
def portal_doc_binary_row(doc, file_type=""):
    ...
    return {
        ...
        "file_size": file_size,
        "mimetype": "",
        "download_url": f"/web/content/{doc._name}/{doc.id}/file/{quote(file_name, safe='')}?download=true",
    }
...
def portal_binary_field_row(record, field_name, filename_field, file_type=""):
    ...
    return {
        ...
        "file_size": file_size,
        "mimetype": "",
        "download_url": f"/web/content/{record._name}/{record.id}/{field_name}/{quote(file_name, safe='')}?download=true",
    }
