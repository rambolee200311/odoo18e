...
class ProjectProjectInherit(models.Model):
    ...
    stock_report_date_mode = fields.Selection([('validation', 'Picking Validation Time'), ('business', 'Order Business Date')], string='Stock Report Date Mode', default='business', required=True, copy=False, index=True)
