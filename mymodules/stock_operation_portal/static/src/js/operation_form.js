// Stock Operation Portal - Form handling
odoo.define('stock_operation_portal.operation_form', function (require) {
    "use strict";
    ...
    publicWidget.registry.OperationForm = publicWidget.Widget.extend({
        ...
        _onProductChange: function (ev) {
            ...
            // Fetch product info via RPC
        },
    });

    return publicWidget.registry.OperationForm;
});
