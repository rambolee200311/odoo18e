...
class StockOperationPortal(CustomerPortal):
    ...
    @http.route(["/my/operation/outbounds/<int:order_id>/edit"], type="http", auth="user", website=True,
                methods=["GET", "POST"])
    ...
    @http.route(["/my/operation/outbounds/<int:order_id>/cancel"], type="http", auth="user", website=True,
                methods=["POST"])
    ...
    @http.route(["/my/operation/outbounds/<int:order_id>/portal_confirm"], type="http", auth="user", website=True,
                methods=["POST"])
    ...
    @http.route(["/my/operation/outbounds/<int:order_id>/portal_unconfirm"], type="http", auth="user", website=True,
                methods=["POST"])
